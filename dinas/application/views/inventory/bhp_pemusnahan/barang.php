<script>
	$(function(){
	   var source = {
		...
		url: "<?php echo site_url('inventory/bhp_pemusnahan/json_barang/'.'8'.'/'.$tgl_opname.'/'.$code_cl_phc); ?>",
		cache: false,
		...
		{	
			...
			columns: [
				...
				{ text: 'Jumlah ', align: 'center',cellsalign: 'right',editable: false,datafield: 'jmlawal', columntype: 'textbox', filtertype: 'textbox', width: '23%'}
           ]
		});
