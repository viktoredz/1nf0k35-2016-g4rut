<script>
	$(function(){
	   var source_opname = {
		...
		url: "<?php echo site_url('inventory/bhp_pemusnahan/json_opnamekanan/'.$kode_opname.'/'.$tgl_opname.'/'.$code_cl_phc); ?>",
		cache: false,
		...
		{	
			...
			columns: [
				...
				{ text: 'Jumlah ', align: 'center',cellsalign: 'right',editable: false,datafield: 'jumlahtidakdipakaiterakhir', columntype: 'textbox', filtertype: 'textbox', width: '23%'}
           ]
		});
