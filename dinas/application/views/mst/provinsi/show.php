...
<form action="<?php echo base_url()?>mst/provinsi/dodel_multi" method="POST" name="">
  <div class="row">
    <!-- left column -->
    <div class="col-md-12">
...
<script type="text/javascript">
	...
	function edit(id){
		document.location.href="<?php echo base_url().'mst/provinsi/edit';?>/" + id;
	}

	function del(id){
		var confirms = confirm("Hapus Data ?");
		if(confirms == true){
			$.post("<?php echo base_url().'mst/provinsi/dodel' ?>/" + id,  function(){
