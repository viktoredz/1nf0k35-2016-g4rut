...
<form action="<?php echo base_url()?>mst/kecamatan/dodel_multi" method="POST" name="">
  <div class="row">
    <!-- left column -->
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header">
	      ...
	      <div class="box-footer">
		 	<button type="button" class="btn btn-primary" onclick="document.location.href='<?php echo base_url()?>mst/kecamatan/add'"><i class='fa fa-plus-square-o'></i> &nbsp; Tambah</button>
	   ...
	   var source = {
		...
		{		
			...
			columns: [
				...
				{ text: 'Kode', datafield: 'code', columntype: 'textbox', filtertype: 'textbox', width: '30%' },
				{ text: 'Value', datafield: 'nama', columntype: 'textbox', filtertype: 'textbox', width: '50%' }
            ]
		});

	function edit(id){
		document.location.href="<?php echo base_url().'mst/kecamatan/edit';?>/" + id;
	}

	function del(id){
		var confirms = confirm("Hapus Data ?");
		if(confirms == true){
			$.post("<?php echo base_url().'mst/kecamatan/dodel' ?>/" + id,  function(){
