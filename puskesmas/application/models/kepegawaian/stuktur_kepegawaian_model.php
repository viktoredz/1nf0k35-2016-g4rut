...
class Stuktur_kepegawaian_model extends CI_Model {
    ...
    {	
	    ...
	    $this->db->where("tar_id_struktur_org_parent",(int)$idparent);
	    $this->db->where("code_cl_phc","P".$this->session->userdata('puskesmas'));
	    $category_query = $this->db->get("mst_peg_struktur_org");
    ...
    {	$puskesmas_ = 'P'.$this->session->userdata('puskesmas');
        ...
        $this->db->join("mst_peg_struktur_org",'mst_peg_struktur_org.tar_id_struktur_org = pegawai_struktur.tar_id_struktur_org AND mst_peg_struktur_org.code_cl_phc="'.$puskesmas_.'"','left');
