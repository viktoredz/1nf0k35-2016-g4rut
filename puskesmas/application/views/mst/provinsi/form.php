...
<form action="<?php echo base_url()?>mst/provinsi/{action}/{kode}" method="POST" name="">
  <div class="row">
    <!-- left column -->
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="box-footer pull-right">
            ...
            <button type="button" class="btn btn-success" onClick="document.location.href='<?php echo base_url()?>mst/provinsi'">Kembali</button>
          </div>
          <div class="box-body">
