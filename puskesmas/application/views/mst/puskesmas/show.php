      ...
      <div class="box box-primary">
        <div class="box-header">
	      ...
	      <div class="box-footer">
		 	<button type="button" class="btn btn-primary" onclick="document.location.href='<?php echo base_url()?>mst/puskesmas/add'"><i class='fa fa-plus-square-o'></i> &nbsp; Tambah</button>
...
<script type="text/javascript">
	$(function () {	
	   ...
	   var source = {
		...
		url: "<?php echo site_url('mst/puskesmas/json'); ?>",
		cache: false,
	...
	function edit(id){
		document.location.href="<?php echo base_url().'mst/puskesmas/edit';?>/" + id;
	}

	function del(id){
		var confirms = confirm("Hapus Data ?");
		if(confirms == true){
			$.post("<?php echo base_url().'mst/puskesmas/dodel' ?>/" + id,  function(){
