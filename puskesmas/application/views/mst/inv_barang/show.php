...
<form action="<?php echo base_url()?>mst/invbarang/dodel_multi" method="POST" name="">
  <div class="row">
    <!-- left column -->
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header">
	      ...
	      <div class="box-footer">
		 	<button type="button" class="btn btn-primary" onclick="document.location.href='<?php echo base_url()?>mst/invbarang/add'"><i class='fa fa-plus-square-o'></i> &nbsp; Tambah</button>
...
<script type="text/javascript">
	$(function () {	
	   ...
	   var source = {
		...
		url: "<?php echo site_url('mst/invbarang/json'); ?>",
		cache: false,
		...
		{		
			...
			columns: [
				...
				{ text: 'Nama', datafield: 'uraian', columntype: 'textbox', filtertype: 'textbox', width: '50%' }
            ]
		});
