    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-footer pull-right">
          ...
          <button type="button" class="btn btn-success" onclick="document.location.href='<?php echo base_url()?>keuangan/jurnal/transaksi_add'"><i class='fa fa-plus-square-o'></i> &nbsp; Tambah Transaksi</button>
        </div>
        <div class="box-body">
          <div class="div-grid">
...
<script type="text/javascript">
  $(function () { 
    ...
    $("select[name='kategori']").change(function(){
        $.post("<?php echo base_url().'keuangan/jurnal/filter_kategori' ?>", 'kategori='+$(this).val(),  function(){
        $("#jqxgrid_jurnal_penyesuaian").jqxGrid('updatebounddata', 'cells');
      });
    });
    ...
    url: "<?php echo site_url('keuangan/jurnal/json_jurnal_penyesuaian'); ?>",
    cache: false,
    updaterow: function (rowid, rowdata, commit) {
      },
    filter: function(){
      $("#jqxgrid_jurnal_penyesuaian").jqxGrid('updatebounddata', 'filter');
    },
    sort: function(){
      $("#jqxgrid_jurnal_penyesuaian").jqxGrid('updatebounddata', 'sort');
    },
    root: 'Rows',
        pagesize: 10,
    ...
    $('#jqxgrid_jurnal_penyesuaian_refresh').click(function () {
      $("#jqxgrid_jurnal_penyesuaian").jqxGrid('clearfilters');
    });
     
    $("#jqxgrid_jurnal_penyesuaian").jqxGrid(
    {   
      width: '100%',
      ...
      columns: [
        { text: 'Detail', align: 'center', filtertype: 'none', sortable: false, width: '5%', cellsrenderer: function (row) {
            var dataRecord = $("#jqxgrid_jurnal_penyesuaian").jqxGrid('getrowdata', row);
  ...
  function detail(id){
    document.location.href="<?php echo base_url().'keuangan/jurnal/transaksi_edit';?>/" + id ;
  }

  // function detail(id){
  //     $.ajax({
  //         url: "<?php echo base_url().'keuangan/jurnal/transaksi_edit'?>/" +id,
  //         type : 'POST',
  ...
  function del(id){
    ...
    if(confirms == true){
      $.post("<?php echo base_url().'keuangan/jurnal/delete_transaksi' ?>/" + id,  function(){
  ...
  $('#btn-add').click(function(){
      $.ajax({
          url : '<?php echo site_url('keuangan/jurnal/transaksi_add/') ?>',
          type : 'POST',
          success : function(data) {
              $('#content2').html(data);
          }
