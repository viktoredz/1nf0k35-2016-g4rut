          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Rekapitulasi 5 Komoditi Sertifikat Terbanyak</h3>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Rekapitulasi 10 Sertifikat Komoditi</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
                ...
                <div class="box-body">
                  <div class="chart">
                    ...
                    <div class="col-md-6">
                      <ul class="chart-legend clearfix">
                        <li class="text-black"><i class="fa fa-circle-o text-blue"></i> Sertifikat </li>
                      </ul>
                    </div>
                  </div>
                </div>
...
<script>
	$(function () {	
      $("select[name='tahun']").change(function(){
        document.location.href="<?php echo base_url().'chart_komd/';?>"+$("select[name='tahun']").val();
      });
		...
		$("#menu_chart_komoditi").addClass("active");
