...
<script type="text/javascript">
	...
	function return_barang(id_barang,barang_kembar_proc,id_inventaris_barang){
		...
		if(confirms == true){
			$.post("<?php echo base_url().'inventory/inv_barang/doreturn_barang_item/'; ?>" + id_barang+'/'+barang_kembar_proc+'/'+id_inventaris_barang,  function(){
	...
	function del_barang(id_barang,barang_kembar_proc,id_inventaris_barang){
		...
		if(confirms == true){
			$.post("<?php echo base_url().'inventory/inv_barang/dodel_barang_item/'; ?>" + id_barang+'/'+barang_kembar_proc+'/'+id_inventaris_barang,  function(){
