            ...
            (
              {
                ...
                url: '<?php echo base_url().'inventory/inv_barang/autocomplite_barang'; ?>'
              },
              {
                autoBind: true,
  ...
  <div id="notice" class="alert alert-success alert-dismissable" <?php if ($notice==""){ echo 'style="display:none"';} ?> >
    ...
    <div class="box box-primary">
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Jumlah</label>
              <input type="text" class="form-control"  readonly name="jumlah" id="jumlah" placeholder="Jumlah" value="<?php 
                  echo $jumlah;
                ?>">
            </div>
            <div class="form-group">
            ...
            <select  name="status_invetaris" type="text" class="form-control" id="status_invetaris" disabled>
